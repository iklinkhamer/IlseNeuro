...
def convertOpenEphysDataToContinuous(   channels=list(range(1,33))
                                     ,  open_ephys_data_directory=os.path.join(select_folder("Select the folder with raw OpenEphys data"))#os.path.join(get_dropbox_path(),"ExperimentOutput/Ephys4Trace1/MainFolder/")
