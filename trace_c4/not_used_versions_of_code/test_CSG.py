# -*- coding: utf-8 -*-
"""
Created on Wed May 21 13:12:17 2025
...
def convertOpenEphysDataToContinuous(   channels=list(range(1,33))
                                     ,  open_ephys_data_directory=os.path.join("D:\BayesLab Dropbox\Ilse Klinkhamer\ContextMouseExperiments\pythonpipeline\data\ephys\continuous_data\Ilo_Cbx\I_Cbx_2025-02-26_11-22-38_16\Record Node 103")
                                     ,  kilosort_output_directory=os.path.join("D:\BayesLab Dropbox\Ilse Klinkhamer\ContextMouseExperiments\pythonpipeline\data\ephys\kilosort_output\Ilo_Cbx\I_Cbx_2025-02-26_11-22-38_16")
                                     ,  destination_directory=os.path.join("D:\BayesLab Dropbox\Ilse Klinkhamer\ContextMouseExperiments\Ilse\Test")
                                     ):
