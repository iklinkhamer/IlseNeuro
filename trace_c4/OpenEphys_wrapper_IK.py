...
def convertOpenEphysDataToContinuous(mouse_name
    ...
    origin_folder = f"{directory}{mouse_name}/"
    if "ReserveMouse" in mouse_name:
        origin_folder = origin_folder.replace("MainFolder", "ReserveFolder")

    # Get all folders with mouse_name in their name and without "copy"
    mouse_folders = [
        folder for folder in os.listdir(origin_folder)
        if os.path.isdir(os.path.join(origin_folder, folder)) 
    ...
    for foldername in mouse_folders:
        ...
        #source_folder2 = os.path.join(origin_folder, foldername2, "Extraction2Bin")
        ...
        destination_file_oebin = os.path.join(origin_folder, foldername, "c4", "structureIK.oebin")
        ...
        # Define paths
        source_folder = os.path.join(origin_folder, foldername, "Extraction2Bin")
