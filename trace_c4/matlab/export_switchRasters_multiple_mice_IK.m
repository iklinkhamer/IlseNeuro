...
function export_switchRasters_multiple_mice_IK(mouseName, kwargs)
arguments
    mouseName = [];
    ...
    kwargs.directory = fullfile(Env.getBayesLabUserRoot, "/TraceExperiments/ExperimentOutput/Ephys4Trace1/MainFolder/");
...
for mouseName = mouseNames
    try
        ...
        if kwargs.evaluateC4Analysis
            ...
            file_path = fullfile(kwargs.directory, mouseName, "SwitchSessionStitching", "c4", "c4_results_fpfnThreshold_0.1_confidenceRatio_1.5", "cluster_predicted_cell_type.tsv");
