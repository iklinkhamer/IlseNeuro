classdef CsPriorCspkCorrelationAnalysis

    methods
        
        function result = CsPriorCspkCorrelationAnalysis(varargin)
            result = CsPriorCspkCorrelationAnalysis.main(varargin{:});
        end
    ...
    methods (Static)
        ...
        function result = main(kwargs)
            arguments
                kwargs.mouseNames (1,:) string = [paperFiguresMice().name];
                kwargs.type (1,1) string = "uniform";
                kwargs.params (1,1) struct = getParams();
                kwargs.outputRoot (1,1) string = ...
                    CsPriorCspkCorrelationAnalysis.defaultOutputRoot;
            end

            p = kwargs.params;
    
            outputDir = fullfile(kwargs.outputRoot, kwargs.type);
            ...
            [allCsTimesCell, allPriorTimesCell, axsCell] = arrayfun ...
                ( @CsPriorCspkCorrelationAnalysis.processMouseResult ...
                , mouseResults ...
                , uniformoutput = false ...
                );
...
%         end
    ...
    function [csTimes, priorTimes] = computeSingleTrial(spikeTimes, p)
