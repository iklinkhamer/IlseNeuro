%% I.K. 1-6-24
function plotRasterWithHistogramAdaptedHeights(ax, rasterXY, range, kwargs)
arguments
    ax
    rasterXY
    range
    ...
    kwargs.nTrials(1,1) double {isnumeric} = IkUtils.getParams().nTrials; % IK change
...
arrayfun ...
    ...
    function highlightRegionHist(spec, normalization)
        ...
        y2 = y1 + length(unique(rasterXY(2,1:3:end))); 
        patch ...
            ( ax ...
            , [x1 x1 x2 x2] ...
            , [y1 y2 y2 y1] ...
    ...
    function highlightRegionText(index, stats)
        ...
        text ...
            ...
            , y ...
            , sprintf("BaseR: %.2f", stats.baserate) ...
            );
        ...
        text ...
            ...
            , y ...
            , sprintf('CorR: %.2f', stats.correctedRate) ...
            );
...
trialIndices = ismember(rasterXY(2, :), uniqueTrials);% Find indices of occurrences of unique trials in rasterXY
...
eventMx = eventMn + max(rasterXY_adapted(2,1:3:end)); 
