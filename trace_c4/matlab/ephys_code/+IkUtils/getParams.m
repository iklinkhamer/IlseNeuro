...
% Paths
kwargs.dirDATA = "/home/no1/Lucas Bayones/BayesLab Dropbox/Lucas Bayones/TraceExperiments/ExperimentOutput/Ephys4Trace1";
kwargs.dirHome = "/home/no1/Documents/";
kwargs.dirHomeData = fullfile(kwargs.dirHome, "Data");
kwargs.dirDATAData = fullfile(kwargs.dirDATA, "MainFolder");
kwargs.dirHomeCode = fullfile(kwargs.dirHome, "code", "IlseNeuro", "trace_c4", "matlab");
kwargs.pathSpikeSortingDATA = fullfile(kwargs.dirDATAData, "AnalyzedEphys");
kwargs.pathSpikeSortingHome = fullfile(kwargs.dirHomeData, "AnalyzedEphys");
kwargs.pathEphysDataDATA = fullfile(kwargs.dirDATAData, "c4", "continuous");
kwargs.pathEphysDataHome = fullfile(kwargs.dirHomeData, "c4", "continuous");
...
kwargs.figPath = fullfile(kwargs.dirHome, "c4_neurons_temp_output");
